...
KERNEL_VERSION=2.6.36.2
INSTALL_MOD_PATH=/home/`whoami`/src/ts-4200/dist/linux-2.6.36/modules-install
...
mv ${TRIM_PATH}/fs/nls/nls_base.ko ${TRIM_PATH}
mv ${TRIM_PATH}/drivers/net/usb/smsc*.ko ${TRIM_PATH}/drivers/net/usb/usbnet.ko ${TRIM_PATH}
rm -rf ${TRIM_PATH}/{crypto,fs,lib,net}
rm -rf ${TRIM_PATH}/drivers/{block,i2c,input,misc,net,spi}
mkdir -p ${TRIM_PATH}/fs/nls ${TRIM_PATH}/drivers/net/usb
mv ${TRIM_PATH}/nls_base.ko ${TRIM_PATH}/fs/nls
mv ${TRIM_PATH}/usbnet.ko ${TRIM_PATH}/smsc*.ko ${TRIM_PATH}/drivers/net/usb
