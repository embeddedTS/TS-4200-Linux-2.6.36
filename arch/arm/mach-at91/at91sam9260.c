...
static struct map_desc at91sam9g20_sram_desc[] __initdata = {
	{
		...
		/* WARNING: 'virtual' entry depends on what precedes.  If that changes, so must 'FPGA_BASE_ADDR_VIRT'. */
		.virtual	= AT91_IO_VIRT_BASE - AT91SAM9G20_SRAM0_SIZE - AT91SAM9G20_SRAM1_SIZE - FPGA_SIZE,
